...
import com.alv.forecast.ui.base.ScopedFragment
...
class CurrrentWeatherFragment : ScopedFragment(), KodeinAware {
    ...
    private fun bindUI() = launch {
        ...
        currentWeather.observe(this@CurrrentWeatherFragment, Observer {
